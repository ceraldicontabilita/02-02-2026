  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6" data-testid="contabilita-avanzata-page">
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Contabilità Avanzata - Anno {selectedYear}</h1>
          <p className="text-slate-400">Calcolo IRES/IRAP in tempo reale e categorizzazione intelligente</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="bg-blue-900/50 text-blue-300 px-3 py-1 rounded-lg text-sm">
            📅 Anno: {selectedYear}
          </div>
          <button
