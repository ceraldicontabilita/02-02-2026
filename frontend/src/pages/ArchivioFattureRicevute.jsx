        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ margin: 0, fontSize: 13, color: '#1976d2', lineHeight: 1.5 }}>
              Questa pagina <strong>verifica e corregge automaticamente</strong> i dati al caricamento:
            </p>
            <ul style={{ margin: '8px 0 0 0', paddingLeft: 20, fontSize: 12, color: '#1976d2', lineHeight: 1.8, columns: 2 }}>
              <li><strong>Fornitori</strong>: associa automaticamente il nome mancante</li>
              <li><strong>Importi</strong>: corregge campi vuoti o errati</li>
              <li><strong>TD24</strong>: marca fatture differite come non riconciliabili</li>
              <li><strong>Duplicati</strong>: rimuove fatture duplicate automaticamente</li>
            </ul>
            {autoRepairStatus && (autoRepairStatus.campi_corretti > 0 || autoRepairStatus.duplicati_rimossi > 0 || autoRepairStatus.fornitori_associati > 0) && (
              <div style={{ 
                marginTop: 10, 
                padding: '8px 12px', 
                background: '#c8e6c9', 
                ...
                ✅ Ultima verifica: {autoRepairStatus.fornitori_associati || 0} fornitori associati, {autoRepairStatus.campi_corretti || 0} campi corretti, {autoRepairStatus.duplicati_rimossi || 0} duplicati rimossi
              </div>
            )}
          </div>
        </div>
