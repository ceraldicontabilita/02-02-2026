...
app.include_router(iva.router, prefix="/api/iva", tags=["IVA/VAT"])
...
# Extended routers
# app.include_router(analytics_extended.router, prefix="/api/analytics", tags=["Analytics Extended"])
# app.include_router(warehouse_extended.router, prefix="/api/warehouse", tags=["Warehouse Extended"])
app.include_router(accounting_extended.router, prefix="/api/accounting", tags=["Accounting Extended"])
app.include_router(haccp_extended.router, prefix="/api/haccp", tags=["HACCP Extended"])
...
app.include_router(pianificazione_extended.router, prefix="/api/pianificazione", tags=["Pianificazione Extended"])
# app.include_router(invoices_metadata_ext.router, prefix="/api/invoices", tags=["Invoices Metadata"])
