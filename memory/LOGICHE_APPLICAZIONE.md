...
## 🆕 AGGIORNAMENTO GENNAIO 2026 - VALIDATORI P0 BLOCCANTI

### Validatori Fatture (Import XML)

```
┌──────────────────────────────────────────────────────────────────────────────┐
│                    VALIDATORI P0 - IMPORT FATTURE                            │
├──────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  FILE: /app/app/routers/invoices/fatture_ricevute.py                         │
│                                                                              │
│  REGOLA 1: Fornitore senza metodo pagamento                                  │
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │ SE supplier.metodo_pagamento è NULL o vuoto                         │    │
│  │ → BLOCCO IMPORT con messaggio:                                      │    │
│  │   "Fornitore {nome} non ha metodo di pagamento configurato"         │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                              │
│  REGOLA 2: Metodo bancario senza IBAN                                        │
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │ SE supplier.metodo_pagamento IN ["bonifico", "banca", "sepa"]       │    │
│  │ E supplier.iban è NULL o vuoto                                      │    │
│  │ → BLOCCO IMPORT con messaggio:                                      │    │
│  │   "Fornitore {nome} ha metodo bancario ma IBAN mancante"            │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```

### Validatore Salari (Pagamento Stipendi)

```
┌──────────────────────────────────────────────────────────────────────────────┐
│                    VALIDATORE P0 - PAGAMENTO SALARI                          │
├──────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  FILE: /app/app/routers/cedolini_riconciliazione.py                          │
│  ENDPOINT: POST /api/cedolini-riconciliazione/{cedolino_id}/registra-pagamento│
│                                                                              │
│  REGOLA: Pagamento contanti post giugno 2018                                 │
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │ SE metodo_pagamento = "contanti"                                    │    │
│  │ E data_cedolino > 2018-06-30                                        │    │
│  │ → BLOCCO PAGAMENTO con messaggio:                                   │    │
│  │   "Legge antiriciclaggio: pagamento stipendi in contanti            │    │
│  │    non consentito dal 1° luglio 2018"                               │    │
│  └─────────────────────────────────────────────────────────────────────┘    │
│                                                                              │
│  NOTA LEGALE: D.Lgs. 231/2007 modificato dalla Legge di Bilancio 2018       │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```

### Endpoint di Verifica P0
